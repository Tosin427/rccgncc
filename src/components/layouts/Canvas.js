    ...
    return (
      <div className="sidebar d-block">
        <div className="sidebar-widget widget-logo">
          <img
            src={process.env.PUBLIC_URL + "/assets/img/logoAndHeadedr.png"}
            className="mb-30"
            alt="img"
          />
          <p>
            Running with a vision of raising exemplary believers, New Convenant
            is the headquarters of the Reedemed Christian Church of God in South
            Australia.
          </p>
        </div>
        {/* Instagram Start */}
