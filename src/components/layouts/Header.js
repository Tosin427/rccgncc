  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <header
          className={
            "sigma_header header-4 can-sticky header-absolute" + stickyHeader
          }
        >
          {/* Top Header Start */}
              ...
              <div className="sigma_header-top-inner">
                <ul className="sigma_header-top-links">
                  <li className="menu-item">
                    {" "}
                    <a rel={"external"} href="tel:+123456789">
                      {" "}
                      <i className="fal fa-phone" /> (+61) 416 280 117
                    </a>{" "}
                  </li>
                  <li className="menu-item">
                    {" "}
